...
$sql = "SELECT orders.*, products.product_price, orders.gcash_reference, orders.acc_name, orders.acc_number, orders.amount_paid
        FROM orders
        INNER JOIN products ON orders.product_name = products.product_name
        WHERE orders.user_id = ?
        ORDER BY orders.order_id DESC"; // Change DESC to ASC if you want ascending order
