...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2024 at 07:49 AM
...
INSERT INTO `orders` (`order_id`, `user_id`, `product_name`, `product_price`, `quantity`, `price_total`, `full_name`, `contact_no`, `address`, `city`, `payment_method`, `order_date`, `status`) VALUES
(16, 17, 'JAMORANT 1-PNK', 1499.00, 1, 1499, 'Testing3', '+639456823067', 'Zone 2', 'Libon, Albay', 'cash_on_delivery', '2024-06-01 14:16:46', 'r'),
(19, 17, 'G.T CUT-3', 1799.00, 6, 10794, 'Coda Sonata', '+639456823067', 'Zone 3', 'Libon, Albay', 'Cash on Delivery', '2024-06-01 17:22:33', 'r'),
(28, 17, 'G.T CUT-3', 1799.00, 2, 3598, 'selected test', '+639456823067', 'Zone 3', 'Oas, Albay', 'Cash on Delivery', '2024-06-01 17:44:44', 'r'),
(29, 17, 'G.T. CUT 3-WHB', 1799.00, 2, 3598, 'selected test', '+639456823067', 'Zone 3', 'Oas, Albay', 'Cash on Delivery', '2024-06-01 17:44:44', 'r'),
(30, 17, 'G.T CUT-3', 1799.00, 1, 1799, 'test test', '+639456823067', 'Zone 3', 'Oas, Albay', 'Cash on Delivery', '2024-06-02 03:59:21', 'c'),
(31, 17, 'JORDAN TATUM 2-MNT', 1699.00, 1, 1699, 'froy rivera', '+639456823067', 'Zone 2', 'Libon, Albay', 'Cash on Delivery', '2024-06-02 04:12:07', 'r'),
(34, 23, 'G.T CUT-3', 1799.00, 4, 7196, 'domi', '+639456821234', 'Zone 2', 'Libon, Albay', 'Cash on Delivery', '2024-06-02 04:36:07', 'r'),
(35, 17, 'G.T CUT ACADEMY', 1599.00, 1, 1599, 'froy rivera', '+639456823067', 'Zone 2', 'Oas, Albay', 'Cash on Delivery', '2024-06-02 04:43:04', 'p');
...
(1, 'PRECISION-6', 'It designed to enable quick players to shift speed and change directions while staying control.', 'featured', 1499.00, 50, 'FEATURED-1.jpg', 'a'),
(2, 'G.T CUT ACADEMY', 'Designed to help you create space for stepback jumpers, backdoor cuts and other game-changing plays,', 'featured', 1599.00, 47, 'FEATURED-2.jpg', 'a'),
(3, 'G.T CUT-3', 'Designed to help you create space for stepback jumpers and backdoor cuts, its sticky multicourt traction helps you stop on a dime and shift gears at will. And when you\'re making all those game-changing plays, the newly added, ultra-responsive ZoomX foam.', 'featured', 1799.00, 36, 'FEATURED-3.jpg', 'a'),
(4, 'JORDAN TATUM 2-UNB', 'The Jordan Tatum 2 would be a better shoe if it weren\'t for the traction. The outsole collects dust.', 'bbshoes', 1699.00, 40, 'BBALL-1.jpg', 'a'),
(5, 'JORDAN TATUM 2-LMP', 'The Jordan Tatum 2 would be a better shoe if it weren\'t for the traction. The outsole collects dust quickly, which hinders performance. ', 'bbshoes', 1699.00, 40, 'BBALL-2.jpg', 'a'),
(6, 'JORDAN TATUM 2-MNT', 'The Jordan Tatum 2 would be a better shoe if it weren\'t for the traction. The outsole collects dust quickly, which hinders performance. ', 'bbshoes', 1699.00, 38, 'BBALL-4.jpg', 'a'),
...
(13, 'G.T. CUT 3-YLW', 'Designed to help you create space for stepback jumpers and backdoor cuts, its sticky multicourt traction helps you stop on a dime and shift gears at will. And when you\'re making all those game-changing plays, the newly added, ultra-responsive ZoomX foam ', 'bbshoes', 1799.00, 50, 'BBALL-10.jpg', 'a'),
...
(16, 'AIR JORDAN 4- TBK', 'Released in 1989, the Air Jordan 4 was the first global release of the franchise, and the first shoe in the line to feature its signature “over-molded” mesh. Another notable feature on the Air Jordan 4 OGs was the Nike Air logo featured on the heel.', 'cashoes', 1799.00, 45, 'CASUAL-1.jpg', 'a'),
...
(18, 'AIR JORDAN 4-INB', 'Released in 1989, the Air Jordan 4 was the first global release of the franchise, and the first shoe in the line to feature its signature “over-molded” mesh. Another notable feature on the Air Jordan 4 OGs was the Nike Air logo featured on the heel', 'cashoes', 1799.00, 45, 'CASUAL-3.jpg', 'a'),
...
(27, 'ADIDAS SAMBA-WS', 'Kick it old school with Samba shoes, a classic since 1950. Their low-profile design, iconic T-toe and rubber gumsole make them unmistakably adidas.', 'cashoes', 1299.00, 45, 'CASUAL-12.jpg', 'a'),
...
(29, 'ADIDAS SAMBA-BLG', 'Kick it old school with Samba shoes, a classic since 1950. Their low-profile design, iconic T-toe and rubber gumsole make them unmistakably adidas.', 'cashoes', 1399.00, 45, 'CASUAL-144.jpg', 'a'),
(30, 'New Balance - WSM', 'Designed for runners seeking a blend of cushioning and stability, these New Balance WSM shoes offer exceptional support with every stride. The lightweight construction ensures a comfortable fit, while the durable outsole provides reliable traction.', 'running_shoes', 1599.00, 20, 'nb-wsm.jpg', 'a'),
...
(21, 'vicky', 'libon', 'vick@gmail.com', '1234567', 'u', 'a'),
(22, 'vicky minaj', 'libon, albay', 'vicky1@gmail.com', '1234567', 'u', 'a'),
